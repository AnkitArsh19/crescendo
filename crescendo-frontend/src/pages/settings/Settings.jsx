...
import { HiOutlineUser, HiOutlineLockClosed, HiOutlineBell, HiOutlineLink, HiOutlineKey, HiOutlineCode } from 'react-icons/hi';
...
const tabs = [
    ...
    { to: '/dashboard/settings/notifications', label: 'Notifications', icon: <HiOutlineBell /> },
