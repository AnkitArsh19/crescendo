...
import com.crescendo.shared.domain.valueobject.UserAgentMetadata;
...
public class UserSession {
    ...
    @Embedded
    @AttributeOverride(name = "value", column = @Column(name = "user_agent", length = 500))
    private UserAgentMetadata userAgent;
    ...
    @Embedded
    @AttributeOverride(name = "value", column = @Column(name = "client_ip", length = 45))
    ...
    @Embedded
    @AttributeOverride(name = "value", column = @Column(name = "last_ip", length = 45))
    ...
    @Embedded
    @AttributeOverride(name = "value", column = @Column(name = "device_id", length = 64))
    ...
    public void applyFingerprint(String userAgent, String clientIp, String deviceId, String deviceLabel) {
        this.userAgent = UserAgentMetadata.of(userAgent);
    ...
    public UserAgentMetadata getUserAgent() {
        return userAgent;
    }

    public void setUserAgent(UserAgentMetadata userAgent) {
    ...
    public void setClientIp(IpAddress clientIp) {
