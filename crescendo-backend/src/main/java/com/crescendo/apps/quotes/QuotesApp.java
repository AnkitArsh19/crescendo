...
public class QuotesApp implements AppDefinition {
    ...
    @Override
    public App toApp() {
        return new App("quotes", "Random Quotes", "Get random inspirational quotes",
                "/icons/quotes.svg", AuthType.NONE,
                List.of(),
                List.of(
                    Map.of(
                        "actionKey", "get-random-quote",
                        "name", "Get Random Quote",
                        "description", "Retrieve a random inspirational quote"
                    ),
                    Map.of(
                        "actionKey", "get-by-category",
                        "name", "Get Quote by Category",
                        "description", "Retrieve a quote from a specific category",
                        "configSchema", List.of(
                            Map.of("key", "category", "label", "Category",
                                   ...
                                   "helpText", "Filter quotes by category")
                        )
                    )
                )
        )
