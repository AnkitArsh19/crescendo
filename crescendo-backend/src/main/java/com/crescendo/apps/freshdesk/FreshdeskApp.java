    ...
    public App toApp() {
        return new App(
                ...
                List.of(
                        ...
                        Map.of("actionKey", "freshdesk:contact:delete", "name", "Delete Contact", "description", "Delete a contact in Freshdesk", "configSchema", List.of(Map.of("key", "contactId", "label", "Contact", "type", "dynamic_dropdown", "resourceType", "contacts", "required", true, "helpText", "Select contact to delete"))),
                        Map.of("actionKey", "freshdesk:contact:get", "name", "Get Contact", "description", "Get a contact from Freshdesk", "configSchema", List.of(Map.of("key", "contactId", "label", "Contact", "type", "dynamic_dropdown", "resourceType", "contacts", "required", true, "helpText", "Select contact to fetch"))),
                        ...
                        Map.of("actionKey", "freshdesk:contact:update", "name", "Update Contact", "description", "Update a contact in Freshdesk", "configSchema", List.of(Map.of("key", "contactId", "label", "Contact", "type", "dynamic_dropdown", "resourceType", "contacts", "required", true, "helpText", "Select contact to update"), Map.of("key", "payload", "label", "JSON payload", "type", "json", "required", true))),
                        ...
                        Map.of("actionKey", "freshdesk:ticket:delete", "name", "Delete Ticket", "description", "Delete a ticket in Freshdesk", "configSchema", List.of(Map.of("key", "ticketId", "label", "Ticket", "type", "dynamic_dropdown", "resourceType", "tickets", "required", true, "helpText", "Select ticket to delete"))),
                        Map.of("actionKey", "freshdesk:ticket:get", "name", "Get Ticket", "description", "Get a ticket from Freshdesk", "configSchema", List.of(Map.of("key", "ticketId", "label", "Ticket", "type", "dynamic_dropdown", "resourceType", "tickets", "required", true, "helpText", "Select ticket to fetch"))),
                        ...
                        Map.of("actionKey", "freshdesk:ticket:update", "name", "Update Ticket", "description", "Update a ticket in Freshdesk", "configSchema", List.of(Map.of("key", "ticketId", "label", "Ticket", "type", "dynamic_dropdown", "resourceType", "tickets", "required", true, "helpText", "Select ticket to update"), Map.of("key", "payload", "label", "JSON payload", "type", "json", "required", true)))
                )
