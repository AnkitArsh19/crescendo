                    ...
                    Map.of(
                        ...
                        "configSchema", List.of(
                            ...
                            Map.of("key", "start", "label", "Start Date/Time",
                                   ...
                                   "default", "{{now}}",
                                   "placeholder", "{{now}} or pick start time",
                                   "helpText", "Start datetime (defaults to workflow execution time)"),
                            Map.of("key", "end", "label", "End Date/Time",
                                   "type", "datetime", "required", true,
                                   "default", "{{now + 1h}}",
                                   "placeholder", "{{now + 1h}} or pick end time",
                                   "helpText", "End datetime (defaults to 1 hour after start)"),
                    ...
                    Map.of(
                        ...
                        "configSchema", List.of(
                            ...
                            Map.of("key", "timeMax", "label", "Before Date",
                                   "type", "datetime", "required", false,
                                   "placeholder", "{{now + 7d}} or pick a date",
