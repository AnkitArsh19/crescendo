                ...
                List.of(
                        Map.of(
                                ...
                                "configSchema", List.of(
                                        Map.of("key", "workspace", "label", "Workspace GID", "type", "text", "required", true),
                                        Map.of("key", "name", "label", "Name", "type", "text", "required", true),
                                        Map.of("key", "notes", "label", "Notes", "type", "textarea", "required", false),
                                        Map.of("key", "projects", "label", "Project GIDs CSV", "type", "text", "required", false)
                                )
                        ),
                        Map.of(
                                ...
                                "configSchema", List.of(
                                        Map.of("key", "project", "label", "Project GID", "type", "text", "required", true)
                                )
                        )
                )
