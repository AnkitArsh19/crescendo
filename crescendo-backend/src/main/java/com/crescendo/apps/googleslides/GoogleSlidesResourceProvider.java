...
/**
 * Lists Google Slides presentations from the user's Drive.
...
public class GoogleSlidesResourceProvider implements ResourceProvider {
    ...
    private List<ResourceOption> listPresentations(String accessToken) {
        try {
            ...
            logger.error("[google-slides] Failed to list presentations: {}", e.getMessage());
            return List.of();
        }
    }
