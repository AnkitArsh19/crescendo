...
@ActionMapping(appKey = "openai", actionKey = "text-complete")
public class OpenAITextHandlers implements ActionHandler {
    ...
    public ActionResult execute(ActionContext context) {
        ...
        body.put("model", config.getOrDefault("model", "gpt-3.5-turbo-instruct"));
        ...
        try {
            ...
            return ActionResult.failure("OpenAI Text Completion failed: " + e.getMessage());
        }
    }
}
