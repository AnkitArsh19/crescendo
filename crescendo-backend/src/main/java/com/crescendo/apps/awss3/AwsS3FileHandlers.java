...
@Component
public class AwsS3FileHandlers extends AwsS3Support {

    @ActionMapping(appKey = "awss3", actionKey = "put-object")
    public ActionResult putObject(ActionContext c) {
        try (var s = s3(c)) {
    ...
    @ActionMapping(appKey = "awss3", actionKey = "get-object")
    public ActionResult getObject(ActionContext c) {
        try (var s = s3(c)) {
    ...
    @ActionMapping(appKey = "awss3", actionKey = "copy-object")
    public ActionResult copyObject(ActionContext c) {
        try (var s = s3(c)) {
    ...
    @ActionMapping(appKey = "awss3", actionKey = "delete-object")
    public ActionResult deleteObject(ActionContext c) {
        try (var s = s3(c)) {
    ...
    @ActionMapping(appKey = "awss3", actionKey = "presign-get-object")
    public ActionResult presignGetObject(ActionContext c) {
    ...
    @ActionMapping(appKey = "awss3", actionKey = "presign-put-object")
    public ActionResult presignPutObject(ActionContext c) {
        try (var p = presigner(c)) {
            Duration expires = Duration.ofMinutes(Math.max(1, Math.min(intCfg(c, "expiresMinutes", 15), 10080)));
