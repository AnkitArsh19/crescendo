                ...
                List.of(
                        Map.of("actionKey", "list-objects", "name", "List Objects", "description", "List objects in a bucket",
                                "configSchema", List.of(
                                        Map.of("key", "bucket", "label", "Bucket", "type", "dynamic_dropdown", "resourceType", "buckets", "required", true, "helpText", "Select S3 bucket"),
                        ...
                        Map.of("actionKey", "put-object", "name", "Put Object", "description", "Upload Base64 data",
                                "configSchema", List.of(
                                        Map.of("key", "bucket", "label", "Bucket", "type", "dynamic_dropdown", "resourceType", "buckets", "required", true, "helpText", "Select S3 bucket"),
                                        Map.of("key", "key", "label", "Object Key (File Path)", "type", "text", "required", true, "placeholder", "images/photo.png"),
                        ...
                        Map.of("actionKey", "get-object", "name", "Get Object", "description", "Download object as Base64",
                                "configSchema", List.of(
                                        Map.of("key", "bucket", "label", "Bucket", "type", "dynamic_dropdown", "resourceType", "buckets", "required", true),
                                        Map.of("key", "key", "label", "Object Key", "type", "dynamic_dropdown", "resourceType", "objects", "dependsOn", List.of("bucket"), "required", true, "helpText", "Select object from bucket"))),
                        Map.of("actionKey", "copy-object", "name", "Copy Object", "description", "Copy an object between S3 keys or buckets",
                                "configSchema", List.of(
                                        Map.of("key", "sourceBucket", "label", "Source Bucket", "type", "dynamic_dropdown", "resourceType", "buckets", "required", true),
                                        Map.of("key", "sourceKey", "label", "Source Object Key", "type", "dynamic_dropdown", "resourceType", "objects", "dependsOn", List.of("sourceBucket"), "required", true),
                                        Map.of("key", "bucket", "label", "Destination Bucket", "type", "dynamic_dropdown", "resourceType", "buckets", "required", true),
                        ...
                        Map.of("actionKey", "delete-object", "name", "Delete Object", "description", "Delete an object",
                                "configSchema", List.of(
                                        Map.of("key", "bucket", "label", "Bucket", "type", "dynamic_dropdown", "resourceType", "buckets", "required", true),
                                        Map.of("key", "key", "label", "Object Key", "type", "dynamic_dropdown", "resourceType", "objects", "dependsOn", List.of("bucket"), "required", true))),
                        ...
                        Map.of("actionKey", "presign-put-object", "name", "Create Upload URL", "description", "Create a temporary presigned upload URL",
                                "configSchema", List.of(
                                        Map.of("key", "bucket", "label", "Bucket", "type", "dynamic_dropdown", "resourceType", "buckets", "required", true),
                                        Map.of("key", "key", "label", "Object Key", "type", "text", "required", true, "placeholder", "uploads/file.pdf"),
                                        Map.of("key", "contentType", "label", "Content Type", "type", "text", "required", false),
                                        Map.of("key", "expiresMinutes", "label", "Expires Minutes", "type", "text", "required", false, "placeholder", "15")))
                )
