...
public class GitHubApp implements AppDefinition {
    ...
    public App toApp() {
        ...
        return new App("github", "GitHub", """
                GitHub is the world's leading platform for software development and version control. The Crescendo GitHub app connects your repositories to automated workflows.

                **What you can do with GitHub in Crescendo:**
                - Automate issue triage (create, update, close, and label)
                - Manage pull requests programmatically
                - Post automated comments on issues and PRs based on external events
                - Create and publish new software releases automatically

                **Triggers available:**
                - New Issue / PR — fire a workflow when tracking work
                - New Commit / Push — trigger CI/CD steps or notifications when code changes
                - New Release — notify marketing or Slack when a version is published
                - New Star — celebrate when your repository gets stared

                **Who should use this:** Engineering teams connecting code activity to external tools (like Jira or Slack), open-source maintainers automating issue replies, and release managers coordinating deployments.

                **Authentication:** OAuth 2.0 (connect your GitHub account) or Personal Access Token (for programmatic and bot usage).
                """,
                ...
                List.of(
                    Map.of("actionKey", "github:issue:create", "name", "Create Issue",
                    ...
                    Map.of("actionKey", "github:issue:update", "name", "Update Issue",
                    ...
                    Map.of("actionKey", "github:pullRequest:create", "name", "Create Pull Request",
                    ...
                    Map.of("actionKey", "github:issue:addComment", "name", "Add Comment",
