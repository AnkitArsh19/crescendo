...
@Entity
@Table(name = "steps_command", indexes = {
...
public class Steps_command {
    ...
    public Steps_command(UUID id, Workflow_command workflow, String name, StepType type, BigDecimal order,
        ...
        this(id, workflow, name, type, StepOrder.of(order), ActionKey.of(actionKey), AppKey.of(appKey), connectionId,
                configuration);
    }
    ...
    public Workflow_command getWorkflow() { return workflow; }
    public void setWorkflow(Workflow_command workflow) { this.workflow = workflow; }

    public Instant getDeletedAt() { return deletedAt; }
    public void setDeletedAt(Instant deletedAt) { this.deletedAt = deletedAt; }

    public StepOrder getOrderVO() { return order; }

    /** Returns raw order as BigDecimal for compatibility. */
    public BigDecimal getOrder() { return order != null ? order.value() : null; }

    public void setOrder(StepOrder order) { this.order = order; }
    public void setOrder(BigDecimal order) { this.order = StepOrder.of(order); }
    ...
    public ActionKey getActionKeyVO() { return actionKey; }

    /** Returns raw action key string for compatibility. */
    public String getActionKey() { return actionKey != null ? actionKey.value() : null; }

    public void setActionKey(ActionKey actionKey) { this.actionKey = actionKey; }
    public void setActionKey(String actionKey) { this.actionKey = ActionKey.of(actionKey); }
