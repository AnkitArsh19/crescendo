...
/**
 * Stores single-use password reset tokens (hashed) for users.
 */
@Entity
...
public class PasswordResetToken {
	...
	@JoinColumn(name = "user_id", referencedColumnName = "id", nullable = false, foreignKey = @ForeignKey(name = "fk_password_reset_user"))
	...
	public PasswordResetToken(UUID id, User_command user, String tokenHash, Instant expiresAt) {
		this.id = id;
		this.user = user;
